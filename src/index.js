...
const ImageCard = ({ photo, titre, button }) => (
  <div className="image-card">
    <img src={photo} />
    <h2 className="image-card-titre">{titre}</h2>
    <button className="image-card-button">{button}</button>
  </div>
);
...
const CountryOptions = () => (
  <select className="service-card-options">
    ...
    <option value="value3"> ISTANBUL </option>
    <option value="value4"> ROME </option>
    <option value="value5"> MEXICO CITY </option>
    <option value="value6"> CURITIBA</option>
...
const Main = () => (
  <div className="container">
    ...
    <div className="container-center">
      ...
      />
      <h1 className="objectif">Making the healthcare experience more human</h1>
      <div
        className="about"
      ...
      >
        <p>
          ...
          the most<br />
          easy way. The patient journey should be enjoyable, and that's why we
          are <br />
          always next to them: to help them find the best possible care.Anytime,
          anywhere.<br />
        </p>
        <p>
          We also help doctors to better manage their practice and build their
          online reputation. <br />
          With our integrated end-to-end solution, doctors are able not only to
          improve their<br />
          online presence, but also to devote their time to what really matters:
          their patients.<br />
        </p>
      </div>
    </div>
    <div>
      ...
      <div>
        <p style={{ color: "#00b39b", fontSize: "20px" }}>
          We are a global <br />company<br /> with local culture
        </p>
        <div>
          <div
            style={{ marginLeft: "700px", color: "#3d83df", padding: "10px" }}
          >
            <svg
        ...
        <div className="features" style={{ justifyContent: "center" }}>
          <div style={{ textAlign: "center" }}>
            <h3 style={{ color: "#00b39b" }}>
              The world's <br />
            ...
            <img
              ...
              src="data:image/jpeg;base64,"
            />
          </div>
      ...
      <div className="objectif2">
        <h1>
          Improve the lives of millions.<br /> Change yours forever
        </h1>
        <p>
          More than 500 team mates share our same vision, goals and passion.<br />
    ...
    <div className="footer">
      <p className="paragraph-footer">
        ...
        <a className="footer-link" href="url1">
          Poland
        </a>
        ,{" "}
        <a className="footer-link" href="url2">
          Turkey
        </a>,
        <a className="footer-link" href="url3">
          Spain
        </a>,
        <a className="footer-link" href="url4">
          Italy
        </a>,
        <a className="footer-link" href="url5">
          Mexico
        </a>,
        <a className="footer-link" href="url6">
          Brazil
        </a>,
        <a className="footer-link" href="url7">
          Argentina
        </a>{" "}
        en
        <a className="footer-link" href="url8">
          Chile
        </a>
        <br />
